...
const ProfileEditPage = () => {
  ...
  return (
    <div className="min-h-screen pb-40 space-y-4 animate__animated animate__fadeIn">
      ...
      <div className="container space-y-4">
        ...
        {myIsPremium ? (
          <div className="space-y-4">
            ...
            {/* Emoji badge */}
            <Card title="Emoji belgi" className="space-y-4">
              <div className="flex items-center gap-4">
                {me?.emojiBadgeId ? (
                  <PremiumEmojiIcon className="size-10" />
                ) : (
          ...
          <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-4 space-y-3">
            ...
            <p className="text-xs text-yellow-700">
              Profil rasm, emoji belgisi, ko'rsatma ism va ism rangini sozlash
